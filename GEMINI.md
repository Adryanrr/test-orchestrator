...
**Core Value:** Demonstrate robust test automation capability with excellent code organization, design patterns (like Page Objects), semantic commits, and continuous integration execution.
